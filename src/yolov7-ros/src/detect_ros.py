...
class Yolov7Publisher:
    ...
    def process_img_msg(self, img_msg: Image):
        ...
        if len(detection_msg.detections) != 0:
            first_bbox = detection_msg.detections[0].bbox
            bbox_center = first_bbox.center
            bbox_size_x = first_bbox.size_x
            bbox_size_y = first_bbox.size_y
            rospy.loginfo(f"Detected Box 1 at x={bbox_center.x}, y={bbox_center.y}, width={bbox_size_x}, height={bbox_size_y}")
        else:
